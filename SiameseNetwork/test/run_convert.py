...
if __name__=="__main__":
    ...
    dataDir = '/store/user/mcarrigan/AMSB/images_v7/images_higgsino_700GeV_100cm_step3/'
    outDir = '/store/user/llavezzo/disappearingTracks/siameseData/higgsino_700GeV_100cm/'
