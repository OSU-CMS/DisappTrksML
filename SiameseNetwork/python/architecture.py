...
class GeneralArchitecture:
	...
	def __init__(self, eta_range=0.25, phi_range=0.25, max_hits=100, phi_layers=[64, 128, 256], f_layers=[256, 512], track_info_indices=0):
	...
	def fit_generator(self, train_generator, val_generator=None, 
		...
		self.model.compile(optimizer=optimizers.Adam(lr = 0.00006), loss='binary_crossentropy', metrics=metrics)
