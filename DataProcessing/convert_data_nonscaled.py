...
np.save(dataDir+'e_DYJets50V3_norm_40x40_nonscaled', e_events)
np.save(dataDir+'bkg_DYJets50V3_norm_40x40_nonscaled', bkg_events)
np.save(dataDir+'reco_DYJets50V3_norm_40x40_nonscaled',reco_results)
