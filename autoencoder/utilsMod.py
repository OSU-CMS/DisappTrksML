...
def metrics(true, predictions, plotDir, endtag, threshold=0.5):
    ...
    plot_confusion_matrix(cm,['bkg','e'],plotDir + 'cm'+ endtag + '.png')
    ...
    fileOut = open(plotDir+"metrics" + endtag + ".txt","w")
