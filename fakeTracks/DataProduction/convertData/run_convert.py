...
if __name__=="__main__":
    ...
    outDir = '/store/user/mcarrigan/fakeTracks/converted_DYJets_aMCNLO_PUTrain_v9p1/'
    logDir = '/data/users/mcarrigan/Logs/fakeTracks/converted_DYJets_aMCNLO_PUTrain_v9p1/'
