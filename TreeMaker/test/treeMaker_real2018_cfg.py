...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2018A/EGamma/AOD/17Sep2018-v2/120000/669F86A4-BEFA-EF42-A925-BD312E5BEAC5.root'),
...
process.trackImageProducer = cms.EDAnalyzer ("TrackImageProducerMINIAOD",
    ...
    dataTakingPeriod = cms.string("2018")
)
